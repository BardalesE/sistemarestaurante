...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // IMPORTANTE: Cambia este email y contraseña antes de ejecutar en producción
        User::create([
            'name'     => env('ADMIN_NAME', 'Administrador'),
            'email'    => env('ADMIN_EMAIL', 'admin@mirestaurante.com'),
            'password' => Hash::make(env('ADMIN_PASSWORD', 'CambiarEsto2024!')),
            'role'     => 'admin'
        ]);
